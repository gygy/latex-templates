...
\BeginIndex{Cmd}{cohead*}%
\BeginIndex{Cmd}{rohead*}%
Die Sternvarianten\ChangedAt{v3.14}{\Class{scrbook}\and \Class{scrreprt}\and
  \Class{scrartcl}} der zuvor erklärten Befehle unterscheiden sich lediglich
bei Weglassen des optionalen Arguments \PName{Inhalt plain.scrheadings} von
der Form ohne Stern. Während die Form ohne Stern in diesem Fall den Inhalt von
...
%  LocalWords:  Paketoptionen Ebenenmodell Sternvariante Sternform
