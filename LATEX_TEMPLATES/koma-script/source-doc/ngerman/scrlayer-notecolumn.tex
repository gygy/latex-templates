...
\KOMAProvidesFile{scrlayer-notecolumn.tex}
                 [$Date: 2014-03-13 17:33:07 +0100 (Thu, 13 Mar 2014) $
...
\Package{scrlayer} als sogenannter\textnote{Proof of concept} \emph{proof of
  concept} entwickelt. Obwohl es sich derzeit noch in einem recht frühen
...
diese bei Auffinden zu melden. Einige \emph{Unzulänglichkeiten} des Pakets
sind jedoch auch der Minimierung des Aufwands geschuldet. So können
Notizspalten zwar über Seiten hinweg umbrochen werden, allerdings findet dabei
...
\end{lstcode}
  ...
  geladen. Somit können Notizspalten auf allen Seiten ausgegeben werden.
...
Befehle funktioniert \Package{scrlayer-notecolumn} nicht. Dabei wird außerdem
...
Kollision\textnote{Kollisionsauflösung} mit einer früheren Notiz in derselben
...
Verschiebungen auftreten, so dass nie ein endgültiger Zustand erreicht
