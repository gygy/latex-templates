...
\documentclass[11pt,letter,dateno,sigleft]{newlfm} % Extra options: 'sigleft' for a left-aligned signature, 'stdletternofrom' to remove the from address, 'letterpaper' for US letter paper - consult the newlfm class manual for more options
...
\includegraphics[width=0.5\linewidth]{logo.png}}} % Company/institution logo at the top left of the page
...
\addrfrom{
Corfu, le 12 décembre 2014\\[12pt] % Date
